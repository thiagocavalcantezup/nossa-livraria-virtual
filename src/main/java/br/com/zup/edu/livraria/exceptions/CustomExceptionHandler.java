package br.com.zup.edu.livraria.exceptions;
...
public class CustomExceptionHandler {
    ...
    @ExceptionHandler(ExemplarReservadoException.class)
    @ResponseBody
    ErroPadronizado handleExemplarReservado(ExemplarReservadoException ex) {
